...
import torch
torch.set_float32_matmul_precision('high')  # A6000 Tensor Core 활용 (import torch 이후여야 함)
...
if __name__ == '__main__':
    ...
    if True:
        ...
        # cfg3.0 multiview is sharper and more 3D-consistent than cfg1.0 → cleaner NEUS mesh.
        input_dir_for_neus = os.path.join(input_root_dir, f"cropsize-{cfg.validation_dataset.crop_size}-cfg{3.0:.1f}", str(cfg.revision))
